...
#ifndef _COLOR_LCD_LIB_
#define _COLOR_LCD_LIB_
...
public:
	...
	void drawImage(int x, int y,char image[],int clearColor,int w,int h);
	
	void printMessage(int clearColor);

	void on(void);
	void off(void);
};

#endif	// _COLOR_LCD_LIB_
